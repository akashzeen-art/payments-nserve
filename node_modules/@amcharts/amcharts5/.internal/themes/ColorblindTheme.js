 ...
 * @important
 */
export class ColorblindTheme extends Theme {
    setupDefaultRules() {
        super.setupDefaultRules();
        this.rule("ColorSet").setAll({
            colors: [
                Color.fromHex(0xe69f00),
                Color.fromHex(0x56b4e9),
                Color.fromHex(0x009e73),
                Color.fromHex(0xf0e442),
                Color.fromHex(0x0072b2),
                Color.fromHex(0xd55e00),
                Color.fromHex(0xcc79a7),
                Color.fromHex(0x000000) // black
            ],
            // Loop the safe set rather than generating off-palette colors, which
            // would break the color-blindness guarantee.
            reuse: true
        });
    }
}
//# sourceMappingURL=ColorblindTheme.js.map